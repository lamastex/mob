...
\begin{figure}
\center{
  \includegraphics[width=0.35\textwidth]{figures/noSwaps}
...
\subfloat[\scriptsize intersection between original and anonymized trajectories] {
  \includegraphics[width=0.5\textwidth]{figures/Rplot19}
  \label{fig:ECDF-a}
}
\hfil 
\subfloat[\scriptsize attackers capability of inferring trajectories from known locations] {
  \includegraphics[width=0.5\textwidth]{figures/Rplot18}
  \label{fig:ECDF-b}
}
