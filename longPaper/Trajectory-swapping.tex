...
Our main contribution here is to formalize the relationship between statistical decision procedures that are used to extract utility from the data on one hand and anonymizers that attempt to guarantee a particular mesure of privacy via anonymity on the other.  
...
the same spatio-temporal cell -- the saptial cell is given by a square of side-length 0.001 degrees ($\chi = 0.001$), about 111
