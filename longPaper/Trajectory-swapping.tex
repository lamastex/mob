...
the same square of height 0.001 degrees ($\chi = 0.001$), about 111
...
coarser grid and smaller squares a finer grid. The resolution of the grid is given by the height of the squares in degrees of latitude {\color{red}\st{and
longitude}} \comment{\st{degrees of latitude are always the same size thus i proposed to change `width' of squares to `height' everywhere, possible `side' instead}} (1 degree of latitude is about 111000 m in Beijing), a lower height then corresponds to a finer grid. Starting
