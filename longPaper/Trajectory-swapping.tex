...
More generally, our approach allows for an arbirtary set of subsets of the city and arbitrary time-intervals to specifiy Origins and Destinations in ODM, but we use a simple grid-based partition at different spatial resolutions to illustrate the effects on privacy here.  
...
were close. It splits the city into four parts, of which two contain
most of the measurements. The smallest width is 0.01 degrees, about
1110 meters, which is then 10 times the distance used for determining
proximity.
