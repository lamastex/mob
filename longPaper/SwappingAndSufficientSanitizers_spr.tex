...
\institute{Juli\'an Salas \at 
		   Internet Interdisciplinary Institute (IN3), Universitat Oberta de Catalunya (UOC), Barcelona, Spain.\\ CYBERCAT-Center for Cybersecurity Research of Catalonia.\\ 
...
\and
		   ...
		   School of Informatics, University of Sk\"{o}vde, Sk\"{o}vde, Sweden. \\
		   \email{vtorra@his.se}   
\and 
		   Marina Toger \at
		   Department of Economic and Cultural Geography, Uppsala University,\\ 
		   \email{marina.toger@kultgeog.uu.se}
\and
		   Joel Dahne \at
		   Department of Mathematics, Uppsala University, Uppsala, Sweden.\\ 
		   \email{joel@dahne.eu}
\and
		   Raazesh Sainudiin \at
		   Department of Mathematics, Uppsala University, Uppsala, Sweden.\\ 
		   \email{raazesh.sainudiin@math.uu.se}
}
...
\keywords{Privacy Preserving Trajectory Mining \and Origin-Destination matrices \and Trajectory anonymization \and Intelligent Transportation Systems \and Sufficient Sanitizer \and Mobility Data Mining}
\end{abstract}


\section{Introduction}

%{\bf This was typeset hastily and the grammatical edits made in SwappingAndSufficientSanitizers.tex did not make it to this tex file. Needs to be redone!}
...
This is modeled by \cite{Beresford04mixzones} as a movement matrix which represents the frequency of ingress and egress points to the mix zone at several times.
...
\begin{figure}
  ...
  \hfil
  \subfloat[\scriptsize Adversary Information Gain for different grid
  sizes.] {
...
%\bibliography{../ReferenceSTAT790}
%\bibliographystyle{plain}
%\bibliography{../JennyThesis/manuscripts/thesis/bibs/general_references,../JennyThesis/manuscripts/thesis/bibs/abc,../JennyThesis/manuscripts/thesis/bibs/siminference,../JennyThesis/manuscripts/thesis/bibs/pavings,../JennyThesis/manuscripts/thesis/bibs/likelihood,../JennyThesis/manuscripts/thesis/bibs/densityest,../JennyThesis/manuscripts/thesis/bibs/seb,../JennyThesis/manuscripts/thesis/bibs/mcmc,../JennyThesis/manuscripts/thesis/bibs/cftp,../JennyThesis/manuscripts/thesis/bibs/kde,../JennyThesis/manuscripts/thesis/bibs/amova,../JennyThesis/manuscripts/thesis/bibs/genetics}
%cat ../JennyThesis/manuscripts/thesis/bibs/*.bib > references.bib
%{\tiny
