...
%		  \includegraphics[width=0.34\textwidth]{cross1.pdf}
%    }
%	\subfloat[\scriptsize After first swap]{
%				  \includegraphics[width=0.34\textwidth]{cross2.pdf}
%   	}
%    \subfloat[\scriptsize After second swap] {
%				  \includegraphics[width=0.34\textwidth]{cross3.pdf}
%   	}
...
%\begin{figure*}
%\center{
%  \includegraphics[width=0.95\textwidth]{Protocol6.pdf}
...
%Also, we argue that since the trajectories published are made from different small segments of trajectories, linking an anonymized trajectory to someone will not reveal his real trajectory, and knowing few real points, an adversary still needs to find that they belong to the same trajectory after the swapping process. 
...
%\begin{figure}
%\center
%  \includegraphics[width=0.5\textwidth]{HomeHour}
...
%\begin{figure}
%\center{
%  \includegraphics[width=0.35\textwidth]{noSwaps}
...
%This tackles a common problem when reidentification occurs, that is, all the data from the re-identified individuals may be revealed.
...
%\begin{figure}
%\subfloat[\scriptsize intersection between original and anonymized trajectories] {
%  \includegraphics[width=0.5\textwidth]{Rplot19}
%  \label{fig:ECDF-a}
%}
%\hfil 
%\subfloat[\scriptsize attackers capability of inferring trajectories from known locations] {
%  \includegraphics[width=0.5\textwidth]{Rplot18}
%  \label{fig:ECDF-b}
%}
