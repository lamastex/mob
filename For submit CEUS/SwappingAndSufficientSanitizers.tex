...
\author[1]{Juli\'an Salas\corref{cor1}}
\ead{jsalaspi@uoc.edu}
\author[1]{David Meg\'ias}
\ead{dmegias@uoc.edu}
\author[2]{Vicen\c{c} Torra}
\ead{vtorra@his.se}
\author[3]{Marina Toger}
\ead{marina.toger@kultgeog.uu.se}
\author[4]{Joel Dahne}
\ead{joel@dahne.eu}
\author[4]{Raazesh Sainudiin}
\ead{raazesh.sainudiin@math.uu.se}
...
\address[1]{Internet Interdisciplinary Institute (IN3), Universitat Oberta de Catalunya (UOC), Barcelona, Spain.\\ CYBERCAT-Center for Cybersecurity Research of Catalonia.}
\address[2]{Hamilton Institute, Maynooth University, Maynooth, Ireland. \\
School of Informatics, University of Sk\"{o}vde, Sk\"{o}vde, Sweden. \\}
\address[3]{Department of Economic and Cultural Geography, Uppsala University, Uppsala, Sweden.}
\address[4]{Department of Mathematics, Uppsala University, Uppsala, Sweden.}
...
A preliminary version of this study appeared in \cite{Salas:2018-c}. The main additions to this study are the formalization of sufficent sanitizer from Section \ref{Sec:SufficientS} and the Origin-Destination matrices privacy and utility from Section \ref{Sec:evaluation}. We also consider a new measure of Information Gain for an attacker that is different from the measures used in previous version.
