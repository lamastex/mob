...
// MAGIC %md
// MAGIC #### Install the osm-parquetizer in the cluster
// MAGIC Clone the repository from [osm-parquetizer project](https://github.com/adrianulbona/osm-parquetizer) and build the library that will be updated to the cluster. 
// MAGIC 
// MAGIC Later, it will be used to load the osm data faster.
